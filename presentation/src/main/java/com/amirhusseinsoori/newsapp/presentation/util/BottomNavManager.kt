...
class BottomNavManager(
  ...
  private val navGraphIds =
    listOf(R.navigation.breaking, R.navigation.search, R.navigation.saved)
  ...
  private var navHistory = BottomNavHistory().apply { push(R.id.breaking) }
  ...
  private fun isFirstTab(): Boolean {
    return bottomNavigationView.selectedItemId == R.id.breaking
  }
